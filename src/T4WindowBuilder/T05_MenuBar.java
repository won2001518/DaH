...
public class T05_MenuBar {
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon(T05_MenuBar.class.getResource("/T4WindowBuilder/Imsges/Image20250717122326.jpg")));
		toolBar.add(btnNewButton);
		
		JButton btnOpen = new JButton("");
		btnOpen.setIcon(new ImageIcon(T05_MenuBar.class.getResource("/T4WindowBuilder/Imsges/Image20250717122345.jpg")));
		toolBar.add(btnOpen);
