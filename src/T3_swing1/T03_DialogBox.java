	...
	private void designView() {
		...
		btn5.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int ans =	JOptionPane.showConfirmDialog(null, "작업을 계속 하시겠습니다까", "작업 종료창", JOptionPane.YES_NO_CANCEL_OPTION);
				if(ans == 0) {
					JOptionPane.showMessageDialog(null, "작업을 계속합니다");
				}
				else if(ans == 1) {
					JOptionPane.showMessageDialog(null, "작업을 마침니다");
					System.exit(0);
				}
				else {
		...
		btn4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
			  ...
			  int ans =	JOptionPane.showConfirmDialog(null, "작업을 계속 하시겠습니다까", "작업 종료창", JOptionPane.YES_NO_OPTION);
				if(ans == 0) {
					JOptionPane.showMessageDialog(null, "작업을 계속합니다");
				}
				else {
